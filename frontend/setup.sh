...
appservices secrets create --app="$APP_ID" --project="$ATLAS_PROJECT_ID" --name="aws-access-key-id" --value="$AWS_ACCESS_KEY_ID"
appservices secrets create --app="$APP_ID" --project="$ATLAS_PROJECT_ID" --name="aws-secret-access-key" --value="$AWS_SECRET_ACCESS_KEY" 
